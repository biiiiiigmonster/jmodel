...
public class MetamodelGenerator {
    ...
    private static final String SINGULAR_ATTRIBUTE_IMPORT = "io.github.biiiiiigmonster.processor.SingularAttribute";
    ...
    public String generate(TypeElement entityElement, ProcessingEnvironment processingEnv) {
        ...
        source.append("    value = \"io.github.biiiiiigmonster.processor.JmodelProcessor\",\n");
