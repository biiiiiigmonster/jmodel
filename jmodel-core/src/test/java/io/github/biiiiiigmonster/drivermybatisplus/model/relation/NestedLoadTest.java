...
import io.github.biiiiiigmonster.drivermybatisplus.entity.Phone;
import io.github.biiiiiigmonster.drivermybatisplus.entity.Post;
import io.github.biiiiiigmonster.drivermybatisplus.entity.Tag;
...
public class NestedLoadTest extends BaseTest {
    ...
    public void shouldLoadPostsWithTagsWhenOneOfPostsEmpty() {
        List<User> userList = findByIds(User.class, Arrays.asList(1L, 10L));
        assertEquals(2, userList.size());
    ...
    public void shouldLoadPostsWithTagsWhenPostsEmpty() {
        List<User> userList = findByIds(User.class, Arrays.asList(10L, 11L));
        assertEquals(2, userList.size());
    ...
    public void shouldLoadPhoneWithTagsByRelated() {
        List<User> userList = findByIds(User.class, Arrays.asList(1L, 3L, 4L));
