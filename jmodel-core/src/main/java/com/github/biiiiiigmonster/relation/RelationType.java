...
public enum RelationType {
    HAS_ONE(HasOne.class, false) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.HasOne<T> getRelation(RelationOption<T> relationOption) {
    ...
    HAS_MANY(HasMany.class, true) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.HasMany<T> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
    ...
    BELONGS_TO(BelongsTo.class, false) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.BelongsTo<T> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
    ...
    BELONGS_TO_MANY(BelongsToMany.class, true) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.BelongsToMany<T, ?> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
    ...
    HAS_ONE_THROUGH(HasOneThrough.class, false) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.HasOneThrough<T, ?> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
    ...
    HAS_MANY_THROUGH(HasManyThrough.class, true) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.HasManyThrough<T, ?> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
    ...
    MORPH_ONE(MorphOne.class, false) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.MorphOne<T> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
    ...
    MORPH_MANY(MorphMany.class, true) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.MorphMany<T> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
    ...
    MORPH_TO(MorphTo.class, false) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.MorphTo<T> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
    ...
    MORPH_TO_MANY(MorphToMany.class, true) {
        @Override
        public <T extends Model<?>> com.github.biiiiiigmonster.relation.MorphToMany<T, ?> getRelation(RelationOption<T> relationOption) {
            Class<T> clazz = relationOption.getClazz();
            Field field = ReflectUtil.getField(clazz, relationOption.getFieldName());
