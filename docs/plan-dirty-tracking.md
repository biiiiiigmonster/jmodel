...
| 任务 ID | 任务描述 | 优先级 | 状态 |
|---------|----------|--------|------|
| P4-01 | 编写 Model dirty-tracking 单元测试 | P0 | 待开始 |
| P4-02 | 编写 setter 拦截测试 | P0 | 待开始 |
| P4-03 | 编写直接字段赋值测试 | P0 | 待开始 |
| P4-04 | 编写反射赋值测试 | P0 | 待开始 |
| P4-05 | 编写 save 后状态重置测试 | P0 | 待开始 |
| P4-06 | 编写事件监听器中使用 dirty-tracking 的集成测试 | P1 | 待开始 |
